...
public class DeceitActivity extends AppCompatActivity {
    public static final String EXTRA_ANSWER_IS_TRUE = "com.example.droidquest.answer_is_true";
    public static final String EXTRA_ANSWER_SHOWN = "com.example.droidquest.answer_is_shown";
